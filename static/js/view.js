...
var MenuItem = React.createClass({
    ...
    mouseClickHandler: function mouseClickHandler() {
    ...
    render: function render() {
        return React.createElement(
            'span',
            { onMouseOver: this.mouseOverHandler, onMouseOut: this.mouseOutHandler, onClick: this.mouseClickHandler },
            this.props.name
        );
    }
});
...
ReactDOM.render(React.createElement(
    MenuItems,
    null,
    React.createElement(MenuItem, { name: 'Next' }),
    React.createElement(MenuItem, { name: 'Done' })
...
var Gallery = React.createClass({
    ...
    adjustLastRow: function adjustLastRow(_$images, totalWidth, margin, imagesInCurrRow, lastRow) {
    ...
    updateHowManyRendered: function updateHowManyRendered() {
    ...
    render: function render() {
        return React.createElement(ImageBoxList, { images: this.state.images, onImageLoad: this.updateHowManyRendered });
    }
});

var ImageBoxList = React.createClass({
    displayName: 'ImageBoxList',

    render: function render() {
        var that = this;
        var imageBoxList = this.props.images.map(function (imgObj) {
            return React.createElement(ImageBox, { key: imgObj.index, path: imgObj.path, onImageLoad: that.props.onImageLoad, imageObj: imgObj });
        });
        return React.createElement(
            'div',
            { id: 'gallery' },
...
var ImageBox = React.createClass({
    ...
    colourPicker: function colourPicker(_$feedbackBox) {
    ...
    mouseClickHandler: function mouseClickHandler(event) {
        var _$imageBox = $(ReactDOM.findDOMNode(this));
        var _$feedbackBox = _$imageBox.find('.feedback-box');
    ...
    render: function render() {
        return React.createElement(
            'div',
            { className: 'image-box', onMouseMove: this.mouseMoveHandler, onMouseOver: this.mouseOverHandler, onMouseOut: this.mouseOutHandler, onClick: this.mouseClickHandler },
            React.createElement(FeedbackBox, null),
            React.createElement(Image, { path: this.props.path, onImageLoad: this.props.onImageLoad })
        );
    }
});
...
var Image = React.createClass({
    ...
    render: function render() {
        return React.createElement('img', { src: this.props.path, onLoad: this.onLoad });
    }
});

var renderGallery = function renderGallery() {
    ReactDOM.render(React.createElement(Gallery, null), document.getElementById('container'));
};

var deRenderGallery = function deRenderGallery() {
